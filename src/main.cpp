...
int64 nChainStartTime = 1476403200;
...
const string strMessageMagic = "JinKeCoin signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 108000000 * COIN;	// 1 billion coins, that all pow coins
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    int64 nSubsidy = 0.1 * nCoinAge * nRewardCoinYear / 365;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JinKeCoin
    bool fStrictPayToScriptHash = true; // Always active in JinKeCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JinKeCoin",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1476403200;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13607058;
        ...
        assert(block.hashMerkleRoot == uint256("038493fa181cf0e4f6d2ad2820fc98d22deac1643fed144ca8405c4d16a8cae8"));
